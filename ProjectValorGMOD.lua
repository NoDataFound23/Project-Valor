...
CreateClientConVar("EZ_bhopv2","0", true ,false )

local function ms_bhop()

  if GetConVarNumber ("EZ_bhopv2") == 1 then
...
CreateClientConVar("EZ_silentaim", 1)

local function epicsilentaim(ucmd)
if GetConVarNumber("EZ_silentaim") == 1 then
		FixMovement(ucmd);
   end
end
...
CreateClientConVar("EZ_annoystormy", 0)
...
local function funnyspam252()
	if GetConVarNumber("EZ_annoystormy") == 1 then
               RunConsoleCommand("ulx","goto", name)
               RunConsoleCommand("ulx","hp","^","500")
               ply:ConCommand( "+attack" )
             end
          end

timer.Create("ezsss", 0.1, 0, funnyspam252)

local function funnyspam2522()
	if GetConVarNumber("EZ_annoystormy") == 1 then
               RunConsoleCommand("ulx","slap","^", "1")
             end
          end

timer.Create("ezssss", 0.9, 0, funnyspam2522)
...
for k,v in pairs(player.GetAll()) do
 ...
 SheetItemOne23:SetText( "Autofire" )
...
SheetItemTwo3445563:SizeToContents()
    ...
    CategoryContentThreeee32:SetConVar( "EZ_bhopv2" )
    ...
    CategoryContentThreeeeeeee332232:SizeToContents()
            ...
            local CategoryContentThreeeeeeee33223222 = vgui.Create( "DCheckBoxLabel", panel3 )
    CategoryContentThreeeeeeee33223222:SetText( "ULX Goto/HP Abuse" )
    CategoryContentThreeeeeeee33223222:SetConVar( "EZ_annoystormy" )
    CategoryContentThreeeeeeee33223222:SetPos( 250, 270 )
    CategoryContentThreeeeeeee33223222:SizeToContents()
...
DermaButton22434.DoClick = function() RunConsoleCommand("lenny_ents") end
	...
	TextEntryPH3.OnEnter = function( self3 )
		chamColour.b = self3:GetValue()  end  
                local TextEntryPH34 = vgui.Create( "DTextEntry", panel3 )
        TextEntryPH34:SetSize( 150, 20 )
        TextEntryPH34:SetPos( 250, 240 )
	TextEntryPH34:SetPlaceholderText( "Libbys Ulx Abuse Name" )
	TextEntryPH34.OnEnter = function( self355 )
		name = self355:GetValue()  end  
